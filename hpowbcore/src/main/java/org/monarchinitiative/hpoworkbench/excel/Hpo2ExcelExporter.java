...
public class Hpo2ExcelExporter {
    ...
    private String getParents(TermId childId){
        ...
        Set<TermId> tids =  getParentTerms(ontology,childId,false);
         return tids.stream().map(TermId::getIdWithPrefix).collect(Collectors.joining("; "));
    }
    ...
    /**
     *
     * @return an array of strings for the header of the output file.
     */
